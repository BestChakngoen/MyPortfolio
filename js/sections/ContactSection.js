                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
                    ...
                    <div className="flex flex-col justify-center items-center bg-gray-900/50 p-8 rounded-2xl border border-gray-700">
                        ...
                        <div className="flex gap-6">
                            <a href="#" className="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg"><Icons.Facebook size={28} /></a>
                            ...
                            <a href="#" className="w-14 h-14 bg-pink-600 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg"><Icons.Instagram size={28} /></a>
                        </div>
                        {isEditing && <div className="mt-4 w-full"><span className="text-xs text-gray-500">Itch.io Link:</span><EditableText value={personalInfo.itch} onChange={(val) => onUpdate(['personalInfo', 'itch'], val)} isEditing={isEditing} /></div>}
